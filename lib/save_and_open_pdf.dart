...
class PdfInvoiceService {
                  ...
                  children: [
                    pw.Text(
                      'Автотранспорт каражаттарынын ээлеринин жарандык-укуктук '
                          'жоопкерчилигин милдеттүү камсыздандыруунун '
                          'КАМСЫЗДАНДЫРУУ ПОЛИСИ / СТРАХОВОЙ ПОЛИС '
  ...
  pw.Widget _buildParagraph1(pw.TextStyle style) {
    return pw.Text(
      'Камсыздандыруу автотранспорт каражатын пайдалануу мезгилинде болгон камсыздандыруу '
          'окуяларына келишимди төмөнкүдөй колдонуу мөөнөтүнүн ичинде '
          'таркатылат / Страхование распространяется на страховые случаи, '
          'произошедшие в период использования автотранспортного средства в '
  ...
  pw.Widget _buildParagraph4(pw.TextStyle style) {
    return pw.Text(
      '4. Камсыздандыруу суммасынын минимумдук өлчөмүнүн чегинде зыян '
          "келтирилгендиги үчүн жоопкерчиликтин төмөнкүдөй лимиттери бекитилет "
          'В пределах минимального размера страховой суммы устанавливаются '
          'следующие лимиты ответственности по причинению вреда - ар бир '
          'жабырлануучунун (жабырлануучулардын) өмүрүнө же ден '
          'соолугуна – 300 000 (үч жүз миң) сом өлчөмүндө; жизни и '
          'здоровью каждого потерпевшего (потерпевших) – в размере 300 000 '
          '(триста тысяч) сомов; - бир жабырлануучунун мүлкүнө – 150 000 '
          '(жүз элүү миң) сом өлчөмүндө, бирок бардык жабырлануучуларга 450 000 '
          '(төрт жүз элүү миң) сомдон ашык эмес; имуществу одного '
          'потерпевшего – в размере 150 000 (сто пятьдесят тысяч) сомов, '
          'но не более 450 000 (четыреста пятьдесят тысяч) сомов на всех потерпевших;',
      style: style,
    );
  }
  ...
  pw.Widget _buildParagraph5(pw.TextStyle style) {
    return pw.Text(
      '5. Камсыздандыруу окуясы болуп автотранспорт каражатын эксплуатациялоо '
          'учурунда жол-транспорт кырсыгынын натыйжасында жабырлануучунун '
          '(үчүнчү жактардын) өмүрүнө, ден соолугуна же мүлкүнө зыян '
          'келтирилгендиги үчүн камсыздандырылуучунун жарандык-укуктук '
          'жоопкерчилиги орун ала тургандыгынын Страховым случаем признается '
          'факт наступления гражданско-правовой ответственности страхователя '
          'по возмещению вреда, причиненного жизни, здоровью или',
      style: style,
    );
  }
  ...
  pw.Widget _buildParagraph6(pw.TextStyle style) {
    return pw.Text(
      '6. имуществу потерпевшего (третьих лиц) в результате дорожно-транспортного происшествия '
          'при эксплуатации автотранспортного средства. Камсыздандыруу полиси Кыргыз Республикасынын аймагында колдонулат. '
          ' полис действует на территории Кыргызской Республики.',
      style: style,
    );
  }
  ...
  pw.Widget _buildParagraph7(pw.TextStyle style) {
    return pw.Text(
      '7.  Камсыздандыруу сый төлөмү 3975.5520000000006 сом, бардык салык '
          'төлөмдөрдү эске алуу менен.Страховая премия 3975.5520000000006 '
          'сом , включено все налоги .',
      style: style,
    );
  }
